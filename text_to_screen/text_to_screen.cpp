...
void write_to_display(){
    ...
    display.println("The top two lines...");
    display.println("are always orange.  ");
    display.printf ("The other lines are \n");
    display.printf ("always blue. *shrug*\n");
    display.println("");
    display.printf ("Each line is 20 wide\n");
    display.printf ("And the screen fits \n");
    display.printf ("8 lines top-to-bttm.\n");
